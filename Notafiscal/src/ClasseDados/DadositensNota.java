...
public class DadositensNota  implements InterfaceIntensNota{
    ...
    @Override
    public void cadastrar(ItensNota intensNot) throws ClassNotFoundException, SQLException {
    ...
    @Override
    public void alterar(ItensNota intensNot) throws ClassNotFoundException, SQLException {
    ...
    @Override
    public void remover(ItensNota intensNot) throws ClassNotFoundException, SQLException {
    ...
    public  ArrayList<ItensNota> listar(ItensNota intensNot) throws ClassNotFoundException, SQLException {    
